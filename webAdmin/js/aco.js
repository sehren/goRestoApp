function aco(koki,order){
	...
	// 	}
		...
		// for(var i=0;i<tmp.length;i++){
		// 	if(tmp[i].qty>10){
		// 		var bagi2 = JSON.parse(JSON.stringify(tmp[i]))
		// 		bagi2.qty /=2
		// 		tmp[i].qty /=2
		// 		bagi22.push(bagi2)
		// 		console.log(bagi2.qty,tmp[i].qty)
		// 	}
		// }
		// for(var i=0;i<bagi22.length;i++){
		// 	tmp.push(bagi22[i])
		// }
	...
	for(var itr=0;itr<iter;itr++){
		...
		// 	var pemetaan = JSON.parse(JSON.stringify(tampungHasilTaboo[i].rute))
		// 	var total = JSON.parse(JSON.stringify(tampungHasilTaboo[i].total))
		// 	var tampungTabu = tabuSearch(total,pemetaan)
		...
		// console.log('tabu list sekarang : ',JSON.parse(JSON.stringify(tabuList)))
		// //update pheromone
		...
		// 	}
		// }
		// console.log(total,JSON.parse(JSON.stringify(pemetaan)) , "iterasi ke ",itr+1)
	}
	var hasilAcoTabu = []
	...
	return {rute : hasilAcoTabu,total : total}
}